...
<template>
    ...
    <div class="content-container">
        <button @click="goBack" class="back-floating-btn">↩️ 영화 목록으로 돌아가기</button>
        <div class="movie-hero-grid">
            <div class="poster-zone">
                <img v-if="store.selectedMovie?.poster_path"
                :src="'https://image.tmdb.org/t/p/w500${store.selectedovie.poster_path}'"
                :alt=" main-poster"
    ...
    <div v-else-if="store.errorMessage" class="ful-screen-error-gate">
